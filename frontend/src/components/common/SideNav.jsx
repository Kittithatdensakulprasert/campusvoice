...
export default function SideNav() {
  ...
  return (
    <>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mobile-menu-toggle__icon">
          {isMobileMenuOpen ? (
      ...
      <aside className={`issue-side-nav ${isMobileMenuOpen ? 'issue-side-nav--open' : ''}`} aria-label="Primary navigation">
        <Link className="issue-side-nav__brand" to="/issues" onClick={() => setIsMobileMenuOpen(false)}>CV</Link>
      ...
      {isStaff && (
        <>
          ...
          >
            ...
            <span className="issue-side-nav__tooltip">แดชบอร์ด</span>
          </Link>
          ...
          >
            ...
            <span className="issue-side-nav__tooltip">จัดการระบบ</span>
          </Link>
        </>
      )}
